...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const navItems = [
    ...
    { name: 'Activity Logs', path: '/activity-logs', icon: History, role: 'Admin' },
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200/50 dark:border-slate-800/40">
          <div className="flex items-center space-x-2">
            <svg className="w-7 h-7 text-brand-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
